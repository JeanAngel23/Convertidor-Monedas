...
public class Principal {
    public static void main(String[] args) throws Exception {
        ...
        Lista nuv = new Lista();
        TipoDeCambio com = new TipoDeCambio();
        Scanner sc = new Scanner(System.in);
        int opcion;
        System.out.println();
        System.out.println(" \nBienvenido/a al conversor de monedas ");
        System.out.println(" Contamos con mas de 161 monedas mundiales que circulan habitualmente.");
        System.out.println("------------------------------------------------------");
        do {
            System.out.println("\n\t\tMenú de opciones:");
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    System.out.print("Ingresa el codigo de Moneda de Origen :  ");
                    String codigoDe = sc.next();
                    System.out.print("Ingresa el codigo de Moneda de Destino :  ");
                    String codigoA = sc.next();
                    System.out.print("Monto : $ ");
                    double monto = sc.nextDouble();
                    try {
                        double resultado = com.convertidor(codigoDe, codigoA, monto);
                        if (resultado != -1) {
                            nuv.agregarRegistro(new TipoDeCambio(codigoDe, codigoA, monto, resultado));
                        }
                    } catch (Exception e) {
